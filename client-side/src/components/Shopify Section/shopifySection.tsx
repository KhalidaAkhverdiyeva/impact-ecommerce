    ...
    <section className="bg-white   py-[100px] lg:px-[48px]">
      <div className="max-w-[1600px] mx-auto flex-col  flex lg:flex-row justify-between">
        <div className="flex flex-col items-center flex-1">
          ...
          <div className="text-[20px] font-[800] mt-[20px]">Free shipping</div>
          <p className="mt-[16px]">
        ...
        <div className="flex flex-col items-center flex-1">
          ...
          <div className="text-[20px] font-[800] mt-[20px]">
            Customer service
          </div>
          <p className="mt-[16px]">
        ...
        <div className="flex flex-col items-center flex-1">
          ...
          <div className="text-[20px] font-[800] mt-[20px]">Refer a friend</div>
          <p className="mt-[16px]">Refer a friend and get 15% off each other</p>
        </div>
        <div className="flex flex-col items-center flex-1">
          <div>
            <svg
          ...
          <div className="text-[20px] font-[800] mt-[20px]">Secure payment</div>
          <p className="mt-[16px]">
