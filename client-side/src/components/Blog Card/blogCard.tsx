...
const BlogCard: React.FC<BlogCardProps> = ({ imgSrc }) => {
  return (
    <div
      className={`flex-1 flex flex-col lg:flex-col max-h-[692px] max-w-[1600px] mx-auto `}
    >
      <div className="flex-[75%]  cursor-pointer overflow-hidden relative">
        <img
          src={imgSrc}
          alt="Blog"
          className="w-[100%] h-[100%] relative transition-transform duration-500 ease-in-out hover:scale-105"
        />
      ...
      >
        <h2 className="text-[26px] md:text-[36px]  font-[800] leading-[1.1] cursor-pointer text-[#272727]">
          The Sowden Collection
        </h2>
        <p className="text-[16px] md:text-[20px] text-[#272727]">
          George Sowden’s kitchen utensil collection for Hay is characterized
          not only by exceptional quality but also by the unique signature of
